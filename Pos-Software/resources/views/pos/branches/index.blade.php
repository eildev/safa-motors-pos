                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name"
                                    class="form-control  @error('name') is-invalid  @enderror" id="exampleInputBranchname2"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('phone') is-invalid  @enderror"
                                    name="phone" id="exampleInputMobile" value="{{ old('phone') }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control  @error('address') is-invalid  @enderror" name="address" id="exampleFormControlTextarea1"
                                    placeholder="Enter Branch Address" rows="5">{{ old('address') }}</textarea>
                                @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                                ...
                                <div class="mb-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <input type="file"
                                                class="categoryImage  @error('logo') is-invalid  @enderror"
                                                value="{{ old('logo') }}" name="logo" id="myDropify" />
                                            @error('logo')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
