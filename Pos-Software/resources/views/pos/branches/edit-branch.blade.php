        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('branch.update', $branch->id) }}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name"
                                    class="form-control  @error('name') is-invalid  @enderror" value="{{ $branch->name }}"
                                    id="exampleInputBranchname2" placeholder="Enter Branch Name">
                                @error('name')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="email" name="email" value="{{ $branch->email }}"
                                    class="form-control  @error('email') is-invalid  @enderror" id="exampleInputBranchname2"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control  @error('address') is-invalid  @enderror" name="address" id="exampleFormControlTextarea1"
                                    placeholder="Enter Branch Address" rows="5">{{ $branch->address }}</textarea>
                                @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-9">
                                <div class="mb-3">
                                    <div class="card">
                                        <div class="card-body">
                                            <input type="file"
                                                class="categoryImage  @error('logo') is-invalid  @enderror" name="logo"
                                                id ="image" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="col-sm-10">
                                    <img class="rounded avatar-lg" id ="showImage"
                                        src="{{ file_exists(public_path('uploads/branch/' . $branch->logo)) && $branch->logo ? asset('uploads/branch/' . $branch->logo) : asset('dummy/image.jpg') }}"
