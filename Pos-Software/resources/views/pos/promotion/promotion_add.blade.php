...
<div class="card">
	<div class="card-body">
		<h6 class="card-title text-info">Add Promotion</h6>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="mb-3 form-valid-groups">
							...
							<input type="text" name="promotion_name" class="form-control field_required" placeholder="Enter promotion name">
						</div>
					</div><!-- Col -->
					<div class="col-sm-6">
						<div class="mb-3 form-valid-groups">
                            ...
                            <div class="input-group flatpickr" id="flatpickr-date">
                                <input type="text" class="form-control" name="start_date" placeholder="Select Start date" data-input>
					...
					<div class="col-sm-6">
						<div class="mb-3 form-valid-groups">
                            ...
                            <div class="input-group flatpickr" id="flatpickr-date">
                                <input type="text" class="form-control" name="end_date" placeholder="Select End date" data-input>
                                <span class="input-group-text input-group-addon" data-toggle><i data-feather="calendar"></i></span>
                              </div>
						</div>
					</div>
                    ...
                    <div class="col-sm-6">
						<div class="mb-3 form-valid-groups">
							...
							<input type="number" name="discount_value" class="form-control field_required" placeholder="Enter discount value">
						</div>
					</div>
                    <div class="col-sm-6">
                        <div class="mb-3 form-valid-groups">
