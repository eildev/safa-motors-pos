...
<head>
    ...
    <title>Reset Password - EIL - Electro || Eclipse Intellitech LTD POS Software</title>
                                ...
                                <div class="col-md-12">
                                    <div class="auth-form-wrapper ">
                                        ...
                                        <form class="forms-sample px-5 py-5" method="POST"
                                            ...
                                            @csrf
                                            <h5 class="text_custom_header text-center fw-normal mb-2">Forgot your
                                                password?</h5>
                                            ...
                                            <div class=" justify-content-center align-items-center d-flex w-full">
                                                <button class="btn btn-primary me-2  mb-2 mb-md-0 text-white custom_btn"
                                                    style="background-color: #2177F7">Email Password Reset Link</button>
